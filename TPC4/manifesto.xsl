...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="elemento">
        <tr>
            <td>
                <ul>
                    <li><xsl:value-of select="./idelemento"/> - <b><xsl:value-of select="./nome"/></b> <p>Email: <a href="mailto:{./email}"><xsl:value-of select="./email"/></a></p> <p>Link GitHub: <a href="./github"><xsl:value-of select="./github"/></a></p></li>
                </ul>
            </td>
            <td>
