        ...
        <xsl:result-document href="website/index.html">
            <html>
                ...
                <body style="background-color:#e6ffff;">
                    <h1 style="text-align:center;">Arquivo de Música Digital</h1>
                    <hr/>
                    <ul>
        ...
        <xsl:result-document href="website/html/obra{@id}.html">
            <html>
                ...
                <body style="background-color:#e6ffff;">
                    ...
                    <p>
                        <address>[<a href="localhost:4002">Voltar à página principal!</a>]</address>
                    </p>
                </body>
            </html>
        </xsl:result-document>
